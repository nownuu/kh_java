...
public class Test02 {
	public static void main(String[] args) {
		//System 클래스
		// = 생성자가 없는 클래스이며 편리하게 이용하도록 전 구성요소가 static 처리가 되어있다.
		
		//통로
		// = System.out 은 표준 출력 통로 객체
		// = System.in 은 표준 입력 통로 객체
		// = System.err는 표준 오류 통로 객체
		...
		//운영체제의 정볼르 읽어올 수 있다.(ex. 환경변수)
		// = System.getPropertise()는 등록된 모든 정보를 반환
		// = System.getProperty("이름")은 해당 이름에 저장된 정보를 반환
		System.out.println(System.getProperties());
		System.out.println(System.getProperty("user.country"));
		String country = System.getProperty("user.country");
		switch(country) {
		case "KR" : System.out.println("만나서 반가워요!"); break;
		case "US" : System.out.println("good to see you"); break;
		}
